...
// Pin the nexus brand palette (collab-web pink/purple identity) — the viewer is
// a public artifact matching the live collab.nexus.agent client, not a per-user export
