/**
 * Web/export palette — the nexus brand identity shared by the collab-web live
 * client (`collab.nexus.agent/`) and every public HTML export / share viewer (`/s/<id>`).
 *
 ...
 * colors for every nexus user. The public web artifacts want the collab-web
