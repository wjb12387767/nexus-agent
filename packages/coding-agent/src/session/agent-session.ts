...
export class AgentSession {
	...
	async exportToHtml(outputPath?: string): Promise<string> {
		// Public HTML export ships in the nexus brand palette (collab-web
		// pink/purple), matching collab.nexus.agent — not the host's terminal theme.
