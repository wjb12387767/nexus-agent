		...
		const options = [
			{
				...
				description:
					"Authenticate via the provider keys and OAuth state already configured under ~/.nexus without opening a new browser-based setup flow.",
			},
			{
				label: "Set up Nexus Agent in terminal",
				description:
