/**
 * Shared wire types for the nexus collab live-session protocol.
 *
...
export const DEFAULT_RELAY_URL = "wss://collab.nexus.agent";

/** Default share viewer/upload base; `/share` links resolve against `<base>/<id>#<key>`. */
export const DEFAULT_SHARE_URL = "https://collab.nexus.agent/s";
