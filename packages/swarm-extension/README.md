...
Register the extension in your config (`~/.nexus/config.json` or `.nexus/config.json`):
...
Any model configured in nexus works. Set a swarm default and optionally override per agent:
