...
- **Session log parsing**: Reads JSONL session logs from `~/.nexus/agent/sessions/`
...
- **Session logs**: `~/.nexus/agent/sessions/` (JSONL files)
- **Stats database**: `~/.nexus/stats.db` (SQLite)
