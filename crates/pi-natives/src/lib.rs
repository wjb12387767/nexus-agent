//! Native utilities exported via N-API for the Nexus Agent toolchain.
//!
//! # Overview
...
// nightly 专属:OOM 错误钩子。stable 编译时禁用(丢失 OOM 崩溃报告,核心功能不受影响)
#![cfg_attr(feature = "nightly", feature(alloc_error_hook))]
