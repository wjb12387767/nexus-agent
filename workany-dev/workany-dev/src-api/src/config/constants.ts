...
export const DEFAULT_AGENT_PROVIDER = 'nexus';
...
/** Primary CLI binary name for the nexus agent */
export const NEXUS_CLI_NAME = 'nexus';

/** Fallback CLI binary names to search for (nexus primary, omp legacy) */
export const NEXUS_CLI_FALLBACK_NAMES = ['nexus', 'omp'];

/** Nexus agent config directory name (used in home directory) */
export const NEXUS_CONFIG_DIR = '.nexus';

/** Nexus settings filename */
export const NEXUS_SETTINGS_FILE = 'settings.json';

/** Nexus custom slash-commands directory name */
export const NEXUS_COMMANDS_DIR = 'commands';
...
/** Get Nexus agent config directory */
export function getNexusDir(): string {
  return join(homedir(), NEXUS_CONFIG_DIR);
}

/** Get Nexus settings file path */
export function getNexusSettingsPath(): string {
  return join(getNexusDir(), NEXUS_SETTINGS_FILE);
}

/** Get Nexus custom commands directory */
export function getNexusCommandsDir(): string {
  return join(getNexusDir(), NEXUS_COMMANDS_DIR);
}
