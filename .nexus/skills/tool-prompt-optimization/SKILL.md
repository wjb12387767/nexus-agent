...
```bash
bun .nexus/skills/tool-prompt-optimization/scripts/probe.ts \
...
```bash
bun .nexus/skills/tool-prompt-optimization/scripts/probe-builtin.ts --tool <name> [--no-summary] [--show]
```
