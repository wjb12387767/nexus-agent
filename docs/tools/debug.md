...
- **Custom adapter config**
  ...
  - Search order mirrors LSP config: project root, project config dirs (`.nexus/`, `.pi/`, `.claude/`), user config dirs, plugin roots, then home-root fallback. Files are merged from lowest to highest priority.
