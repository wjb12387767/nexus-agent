...
## Side Effects
- Filesystem: writes or deletes files under `~/.nexus/agent/managed-skills`.
- Network: none.
...
## Notes
- Managed skills are generated under `~/.nexus/agent/managed-skills` and never edit user-authored skills.
