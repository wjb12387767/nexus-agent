...
2. Managed venv at `~/.nexus/python-env`
...
- **No Python on PATH** — Install a system Python 3.8+ or place a venv at `~/.nexus/python-env`. `nexus setup python --check` reports the resolved interpreter.
