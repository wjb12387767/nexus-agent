...
- default agent dir: `~/.nexus/agent`
- effective default file: `~/.nexus/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.nexus/agent/themes/my-theme.json`.
